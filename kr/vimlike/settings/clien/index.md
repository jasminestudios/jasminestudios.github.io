...
## 설치
1. 링크를 클릭하여 [클리앙 웹사이트 설정 파일](https://www.jasminestudios.net/vimlike/settings/www%2Eclien%2Enet%2E-1%2E0%2Evimlike) 을 다운로드합니다.
...
## 팁
Vimlike의 웹사이트 설정은 기본적으로 웹사이트에 지정된 자바스크립트와 CSS를 적용합니다. 자바스크립트와 CSS의 기본적인 문법을 아신다면, Vimlike앱에서 쉽게 클리앙 웹사이트 설정을 커스터마이즈할 수 있습니다.
